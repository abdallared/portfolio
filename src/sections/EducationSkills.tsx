...
const skillsData: Record<typeof tabs[number], { name: string; level: string; icon: SkillIconKey }[]> = {
  Programming: [
    ...
    { name: 'C++', level: 'Intermediate', icon: 'cplusplus' },
  ...
  Tools: [
    ...
    { name: 'AWS', level: '', icon: 'aws' },
    { name: 'Jupyter', level: '', icon: 'jupyter' },
    { name: 'Google Colab', level: '', icon: 'colab' },
    { name: 'Kaggle', level: '', icon: 'kaggle' },
  ...
  Fundamentals: [
    ...
    { name: 'Databases', level: '', icon: 'databases' },
    { name: 'APIs', level: '', icon: 'apis' },
  ],
};

const coursework = [
  'Data Structures', 'Software Engineering', 'Generative AI', 'Neural Networks',
  'Data Mining', 'ML Algorithms', 'Databases', 'Operating Systems',
  'NLP', 'Image Processing', 'TensorFlow', 'Cutting-edge AI',
];
